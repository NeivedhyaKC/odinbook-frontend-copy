  ...
  return (
    <div id="mainLayout">
      ...
      <ListModal
        ...
        listModalList={listModalList}
        noAdditionalOps
      />
      <ListModal
        showListModal={showListModal2}
        setShowListModal={setShowListModal2}
        listModalList={listModalList2}
        withAccept
        withReject
        setFriendRequestsList={setListModalList2}
        setFriendsList={setListModalList3}
      />
      <ListModal
        showListModal={showListModal3}
        setShowListModal={setShowListModal3}
        listModalList={listModalList3}
        noAdditionalOps
      />
      <div
        id="appbarMenuOverlay"
        ref={appbarMenuOverlayElement}
        onClick={() => CloseAppBarMenu()}
      ></div>
        ...
        <div id="menuChild">
          ...
          <div onClick={() => CloseAppBarMenu()}>
            ...
            <MenuButton
              ...
              color="secondary"
              id="menuFriends"
              onClick={() => onFriendsSeelAllButtonClick()}
              startIcon={
                <GroupIcon
                  color="primary"
                  sx={{
            ...
            <MenuButton
              variant="text"
              color="secondary"
              id="menuFriendRequests"
              onClick={() => onFriendReqSeeAllButtonClick()}
              startIcon={
                <PersonAddIcon
                  color="primary"
                  sx={{
      ...
      <div id="sideDiv">
        <div id="sideDivChild">
          ...
          <div
            className="friendsWithProfileCardContainer"
            id={`${showFriendsContainer1 ? "friendsContainer1" : ""}`}
          >
            ...
            {listModalList3
              ...
              : null}
            {listModalList3 && listModalList3.length === 0 ? (
              <p id="noFriendRequests">No friends yet.</p>
            ) : null}
          </div>
          <div
            id={`${showFriendsContainer2 ? "friendsContainer2" : ""}`}
            className="friendsWithProfileCardContainer"
          >
            <div className="friendsContainer">
              <p>Friend Requests</p>
